...
@section('content')
    {!! Form::open(['route' => ['admin.siswa.jurusan.update', $jurusans->id], 'method' => 'put' , 'enctype' => 'multipart/form-data']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('siswa::admin.jurusans.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach
